...
Then /^contains the correct missing word questions$/ do
  ...
  @questions[0][:answer].style.should eql(:missing_word)
  @questions[0][:question].should eql("Sally sells")
  @questions[0][:question_post].should eql("by the seashore.")
  ...
  @questions[1][:answer].style.should eql(:missing_word)
  @questions[1][:question].should eql("Oh woe is me,")
  @questions[1][:question_post].should eql("woe is me!")
  ...
  @questions[2][:answer].style.should eql(:missing_word)
  @questions[2][:question].should eql('You say that, "money is the root of all evil", I ask you "what is the root of all')
  @questions[2][:question_post].should eql('?"')
  ...
  @questions[3][:answer].style.should eql(:missing_word)
  @questions[3][:question].should eql('Ooh Eee {Uh} Ooh Ah Ah')
  @questions[3][:question_post].should eql("Walla Walla Bing Bang!")
