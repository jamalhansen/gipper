...
Then /^contains the correct multiple choice questions$/ do
  ...
  @questions[1][:answer].style.should eql(:multiple_choice)
  ...
  @questions[2][:answer].style.should eql(:multiple_choice)
  ...
  @questions[3][:answer].style.should eql(:multiple_choice)
  ...
  ## if not more!
  #}
  @questions[4][:answer].style.should eql(:multiple_choice)
  ...
  @questions[5][:answer].style.should eql(:multiple_choice)
