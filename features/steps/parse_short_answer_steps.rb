...
Then /^contains the correct short answer questions$/ do
  ...
  @questions[0][:answer].style.should eql(:short_answer)
  @questions[0][:question].should eql("Coffee is made from")
  ...
  @questions[1][:answer].style.should eql(:short_answer)
  @questions[1][:question].should eql("Coffee is best when")
  ...
  @questions[2][:answer].style.should eql(:short_answer)
  @questions[2][:question].should eql("The only way to spell coffee is:")
